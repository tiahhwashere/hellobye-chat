...
## Tasks
- [x] 1. Add welcome modal HTML (one-time popup shown only on new account creation)
- [x] 2. Add CSS for welcome modal (clean, professional, branded)
- [x] 3. Add showWelcomeModal() JS function + trigger it only after signup (not login/refresh)
- [x] 4. Simplify the "This Profile is Private" subtitle to be basic but semi-professional
- [x] 5. Syntax check, commit, push to GitHub, deploy to Render, verify live (no data wiped)
