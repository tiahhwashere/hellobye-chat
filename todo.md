...
# Round 5f — Members list right-click: always show Open + Close Conversation

## Tasks
- [x] 1. Members list context menu always shows both Open Conversation and Close Conversation (when DMs enabled)
- [x] 2. Open Conversation calls ensureDMConversation + openDM so user appears in Messages tab even with no messages sent
- [x] 3. Close Conversation calls closeDM which removes user from Messages tab (already worked)
