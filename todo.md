...
- [x] Verify on live site (deployed, chat-loading-overlay present)
...
- [x] Verify on live site (deployed, group-attach-dropdown present)
...
- [x] Verify on live site (deployed, group-add-toggle + allowGroupAdd present)

## 4. Deploy & verify all
- [x] Commit, push, verify Render deploy (commit 246d15b, status: live)
- [x] Test all 3 features on live site (all present in served HTML)
